...
public:
	///<summary>
	/// 
	/// DO NOT USE. Use this instead: https://directxtex.codeplex.com/wikipage?title=Texassemble&referringTitle=Texconv
	///</summary>
	static ID3D11ShaderResourceView* CreateTexture2DArraySRV_DO_NOT_USE(
...
public:
	///<summary>
	/// Converts DirectX::DirectX::XMVECTOR to DirectX::PackedVector::XMCOLOR, where DirectX::DirectX::XMVECTOR represents a color.
	///</summary>
	...
	///<summary>
	/// Converts DirectX::DirectX::XMVECTOR to DirectX::XMfloat4, where DirectX::DirectX::XMVECTOR represents a color.
	///</summary>
